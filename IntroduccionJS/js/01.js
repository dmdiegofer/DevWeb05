...
var product = "Headset Gamer"; /* Variable initialized & Value assigned */
var stock; /* variable initialized but with out value. */
// JS A DINAMIC LANGUAGE 
//product = true;  JS can reassign the value and the nature of a variable dinamiclly

stock = true;/*  you don't have to use ';' because it doesn't return an error and the sentence works.
...
// VARIABLE STYLES
var first_name = 'Edilberth'; // Underscore
var secondName = 'Tulio'; // Camelcase
var LastName = 'Aristizabal'; // Pascal Case
var emailadress = 'edituari@wtf.com'; // Lowercase
